  ...
  return (
    <MainLayout title="Jesús Brito" active={1}>
      <Container>
        <section className={style.header} id="sectionAbout">
          <Row>
            <Col sm={12} md={9} className="order-2 order-md-1 mt-3 m-md-0">
              ...
              <p>
                Por 5 años he trabajado con empresas del sector finaciero,
                gobierno, salud y asegurador ayudándoles a programar nuevas
                ideas.
              </p>
              <ul>
                <li>
                  <a
                    href="https://blog.jesusbritodeveloper.com/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Blog
            ...
            >
              <img
                ...
                className="w-75 rounded-circle shadow"
        ...
        <section
          className="mb-5 animate__animated animate__jackInTheBox"
          id="sectionAboutMe"
        >
          <h2 className={style.submenu_header}>Sobre mí</h2>
          <p className={style.text}>
            Soy un desarrollador Full Stack Mobile apasionado por compartir mi
            conocimiento con otras personas. Me considero autodidacta,
            proactivo, innovador y creativo, en busca de crecimiento constante
            que me lleven a probar nuevas experiencias.
          </p>
          <p className={style.text}>
            Pienso que las relaciones personales son importantes para el
            crecimiento profesional y es por eso, que disfruto mucho la compañía
            de mis seres queridos. Soy amante de las nuevas tecnologías y todo
            lo que engloba este apasionante mundo, uno de mis pasatiempos es la
            lectura de ciencia ficción, así como de la científica.
          </p>
        </section>
        ...
        <section className="mb-5" id="sectionProjects">
          ...
          <Row>
            {projectsMock.map((data) => (
              <Col className="my-3" md={4} key={data.id}>
                <CardProject project={data} showProject={showProject} />
              </Col>
            ))}
          </Row>
        </section>
